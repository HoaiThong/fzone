...
$notify_content = 'Bạn không thể tạo cửa hàng! Vui lòng liên hệ với CSKH';
$notify_label = 'Thông báo!';
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Danh sách cửa hàng</h1>
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-4 store_font create_store_btn"  onclick="createStore()">
...
<script>
    function createStore() {
        var nStore =<?php echo $_nStore; ?>;
        var msg = 'Bạn không thể tạo cửa hàng!';
        if (nStore == 0) {

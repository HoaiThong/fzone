<div class="modal fade" id="notifyErrorModal" tabindex="-1" role="dialog" aria-labelledby="notifyErrorModal" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-body">
                    <p>Không thể thực hiện hành động này !</p>

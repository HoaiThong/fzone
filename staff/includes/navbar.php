...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php" style="background: red;">
    ...
    <li class="nav-item">
        <a class="nav-link" href="productsView.php">
            <i class="fas fa-fw fa fa-cubes"></i>
            <span>SẢN PHẨM </span></a>
        <a class="nav-link" href="oderView.php">
            <i class="fas fa-fw fa fa-shopping-bag"></i>
            <span>GIỎ HÀNG</span></a>
        <a class="nav-link" href="staffsView.php">
